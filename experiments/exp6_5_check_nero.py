...
def run_experiment(seed=44, embedding_size=EMBEDDING_SIZE, learning_rate=0.002):
    ...
    return run_generic_experiment(
        ...
        name='double_linear_nero_pretrained',
        seed=seed,
        ...
        top_neural_model=TopNeuralModels.ID_NERO_CHECK,
