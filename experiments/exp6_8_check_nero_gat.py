...
def run_experiment(seed=44, embedding_size=EMBEDDING_SIZE, learning_rate=0.002,  two_layered=False):
    ...
    return run_generic_experiment(
        ...
        name='double_linear_GAT_nero_pretrained',
        seed=seed,
