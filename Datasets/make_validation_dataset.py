...
from config import ORIGINAL_FUNCTIONS_FEATURES_FOLDER_NAME, \
    ...
    PROGRAM_GRAPH_FUNCTION_NODE_SHOULD_VALIDATE, PROGRAM_NAME, PROGRAM_ID, logger, MAX_FILES_NUMBER, DatasetDirs, \
    all_programs_dataset_files, datasets_location, all_programs_dataset_dirs_validation
...
class MergeFunctionsDataIntoNetworkxValidation():
    ...
    def process_and_save_to_raw_dataset_path(self):
        ...
        for stripped_function_features_file_name in os.listdir(
            ...
            #     continue
            #VALIDTION
            if i in ([0] + list(range(0, 3950))) + list(range(4070, 5000)):
                i = i + 1
                continue
            i = i + 1
...
# print(all_programs_dataset_dirs_validation.decompiled_binaries_data_dir, all_programs_dataset_dirs_validation.raw_dir)
MergeFunctionsDataIntoNetworkxValidation(all_programs_dataset_dirs_validation.decompiled_binaries_data_dir, all_programs_dataset_dirs_validation.raw_dir)