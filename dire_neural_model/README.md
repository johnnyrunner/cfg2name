...
python -m utils.preprocess C:\Users\USER\Desktop\University\RE\datasets\dire\0-trees.tar.gz "path/to/binary/dataset/*.tar.gz"  data/preprocessed_data
```
...
python exp.py \
   test --cuda --extra-config='{"data": {"vocab_file": "data/vocab.bpe10000/vocab"}, "decoder": {"remove_duplicates_in_prediction": true, "vocab_file": "data/vocab.bpe10000/vocab"}, "encoder": {"graph_encoder":{"vocab_file": "data/vocab.bpe10000/vocab"}, "seq_encoder":{"vocab_file": "data/vocab.bpe10000/vocab"}}}' data/saved_models/model.hybrid.bin data/preprocessed_data/test.tar
