...
class RecurrentSubtokenDecoder(Decoder):
    def __init__(self, variable_encoding_size: int, hidden_size: int, dropout: float, tie_embed: bool, input_feed: bool, vocab: DireVocab):
    ...
    def forward(self, src_ast_encoding, prediction_target):
        ...
        att_tm1 = variable_encoding.new_zeros(src_ast_encoding['batch_size'].item(), self.lstm_cell.hidden_size)
