...
class GatedGraphNeuralNetwork(nn.Module):
    ...
    def compute_node_representations(self,
        ...
        for edge_type_idx, adjacency_list_for_edge_type in enumerate(adjacency_lists): # CHANGED - original
        # for edge_type_idx, adjacency_list_for_edge_type in enumerate(adjacency_lists[0]): # CHANGED
        ...
        for layer_idx, num_timesteps in enumerate(self.layer_timesteps):
            ...
            for t in range(num_timesteps):
                ...
                if env_vars.use_gpu:
                    message_targets = message_targets.cuda()
