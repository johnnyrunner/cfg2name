...
from dire_neural_model.model.encoder import *
from dire_neural_model.utils import nn_util, util
from dire_neural_model.utils.dataset import Example
from dire_neural_model.utils.dire_vocab import PAD_ID, DireVocab
import torch
...
class SequentialEncoder(Encoder):
    def __init__(self, config):
        ...
        self.vocab = vocab = DireVocab.load(config['vocab_file'])
