...
from .model import RenamingModel
from dire_neural_model.utils import nn_util, util
from dire_neural_model.utils.dire_vocab import END_OF_VARIABLE_TOKEN, SAME_VARIABLE_TOKEN
...
class EnsembleModel(nn.Module):
    ...
    def predict(self, examples):
        ...
        variable_nums = [len(e._ast.variables) for e in examples]
