...
for seed in [52, 53, 54, 55, 56]:
    test_dicts.append(run_experiment_3_7(seed=seed, learning_rate=0.01, embedding_size=10))
    ...
    test_dicts.append(run_experiment_3_7(seed=seed, learning_rate=0.01, embedding_size=100))
